...
class App extends React.Component {
  constructor(props) {
    super(props);
    this.conn = new Strophe.Connection('http://10.50.200.45:7070/http-bind/');
    this.state = {
      username: 'admin',
      status: '未登录',
      roomList: [],
  ...
  componentWillMount() {
    this.conn.connect(this.state.username+'@10.50.200.45/web', 'admin', this.onConnect.bind(this));
  }
